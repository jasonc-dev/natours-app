...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiamFzb25jb2hlbjA3IiwiYSI6ImNrbTRxM2p2YTA3Mm4yeG42cXZzbGNpaDMifQ.3MbrPw6-ZEJFlXkZlnaN7g';
  ...
  regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51IUCaIKOgKA4e07YoIVxyjoFJ3qFVGK82dNgcgMvNU71RJ4XWslbTL64I77QyqQWk6i9Wi6dbqVzCkEK4FKxm1Vx00EL09FUp5');
            _context.prev = 1;
            _context.next = 4;
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  e.target.textContent = 'Processing....'; // get element that is clicked i.e. the button
